    ...
    <div id="ukAsin" class="tab-pane fade show active">
        ...
        <div class="row">
            ...
            <p class="col-md-8 tcb-helptext p-3">
                ...
                <a style="font-weight: bold; font-size: 14px">Selected: <span style="color: rgb(175, 2, 2)">{{ !empty($uk_cat_name) ? $uk_cat_name : '' }}</span></a>
    ...
    <div class="card-footer">
        <div class="row save-buttons col-md-12">
            ...
            <div class="col-md-11">
                ...
                <button id="updateAmazonItem" class="btn btn-lg btn-icon btn-danger" data-url="{{ route('tcb-amazon-sync.amazon.item.updateOnline', ['id' => $amzItem->id, 'country' => 'Uk']) }}">
                    <span class="btn-inner--text">{{ trans('tcb-amazon-sync::items.amazon.updateonline') }} - UK</span>
                </button>
            </div>
            @else
            <div class="col-md-4">
                <button id="uploadAmazonItem" class="btn btn-lg btn-icon btn-info" data-url="{{ route('tcb-amazon-sync.amazon.item.upload', ['id' => $amzItem->id, 'country' => 'Uk']) }}">
