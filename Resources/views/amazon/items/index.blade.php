                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            <th class="col-sm-1 col-md-1 col-lg-1 col-xl-1 d-none d-sm-block">{{ Form::bulkActionAllGroup() }}</th>
                            ...
                            <th class="col-lg-2 col-xl-2 text-center d-none d-md-block">{{ trans('tcb-amazon-sync::general.warnings') }}</th>
                            <th class="col-lg-2 col-xl-2 d-none d-lg-block">{{ trans_choice('general.categories', 1) }}</th>
                            <th class="col-lg-1 col-xl-1 text-center d-none d-md-block">{{ trans('tcb-amazon-sync::general.stock') }}</th>
                            <th class="col-lg-1 col-xl-1 text-right d-none d-lg-block">{{ trans('tcb-amazon-sync::items.price') }}</th>
                            <th class="col-md-1 col-lg-1 col-xl-1 text-right d-none d-md-block">{{ trans('tcb-amazon-sync::items.sale_price') }}</th>
                            <th class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 text-center"><a>{{ trans('general.actions') }}</a></th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                <td class="col-sm-1 col-md-1 col-lg-1 col-xl-1 d-none d-sm-block">
                                    {{ Form::bulkActionGroup($item->id, $item->title) }}
                                </td>
                                ...
                                <td class="col-lg-2 col-xl-2 d-none d-lg-block text-center">
                                ...
                                <td class="col-lg-1 col-xl-1 text-left d-none d-md-block text-center">
                                    {{ $item->quantity }}
                                </td>
                                <td class="col-md-1 col-lg-1 col-xl-1 text-right d-none d-md-block text-center">
                                    {{ $item->price }}
                                </td>
                                <td class="col-md-1 col-lg-1 col-xl-1 text-right d-none d-md-block text-center">
                                    {{ $item->sale_price }}
