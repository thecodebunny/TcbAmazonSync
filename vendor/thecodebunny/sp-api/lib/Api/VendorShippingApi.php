...
class VendorShippingApi
{
     ...
     *
     * @param  \Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsRequest $body body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse
     */
     ...
     *
     * @param  \Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsRequest $body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitShipmentConfirmationsWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\VendorShipping\SubmitShipmentConfirmationsResponse',
