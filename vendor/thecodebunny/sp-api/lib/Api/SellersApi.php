...
class SellersApi
{
     ...
     * @return \Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse
     */
     ...
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceParticipationsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\Sellers\GetMarketplaceParticipationsResponse',
