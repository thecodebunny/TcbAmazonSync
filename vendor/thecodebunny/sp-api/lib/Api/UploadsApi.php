...
class UploadsApi
{
     ...
     * @return \Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse
     */
     ...
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUploadDestinationForResourceWithHttpInfo($marketplace_ids, $content_md5, $resource, $content_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\Uploads\CreateUploadDestinationResponse',
