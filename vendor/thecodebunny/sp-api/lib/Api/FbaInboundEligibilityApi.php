...
class FbaInboundEligibilityApi
{
     ...
     * @return \Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse
     */
     ...
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemEligibilityPreviewWithHttpInfo($asin, $program, $marketplace_ids = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\FbaInboundEligibility\GetItemEligibilityPreviewResponse',
