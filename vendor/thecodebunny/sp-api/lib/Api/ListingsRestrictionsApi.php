...
/**
 * ListingsRestrictionsApi Class Doc Comment
 *
 * @category Class
 * @package  Thecodebunny\SpApi
 */
class ListingsRestrictionsApi
{
     ...
     * @return \Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList
     */
     ...
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingsRestrictionsWithHttpInfo($asin, $seller_id, $marketplace_ids, $condition_type = null, $reason_locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList' === '\SplFileObject') {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList',
