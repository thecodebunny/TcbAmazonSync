...
class VendorDirectFulfillmentInventoryApi
{
     ...
     * @param  \Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateRequest $body body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse
     */
     ...
     *
     * @param  string $warehouse_id Identifier for the warehouse for which to update inventory. (required)
     * @param  \Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateRequest $body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInventoryUpdateWithHttpInfo($warehouse_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentInventory\SubmitInventoryUpdateResponse',
