...
class VendorDirectFulfillmentTransactionsApi
{
     ...
     * @return \Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse
     */
     ...
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionStatusWithHttpInfo($transaction_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentTransactions\GetTransactionResponse',
