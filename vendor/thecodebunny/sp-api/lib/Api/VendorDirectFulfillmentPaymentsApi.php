...
/**
 * VendorDirectFulfillmentPaymentsApi Class Doc Comment
 *
 * @category Class
 * @package  Thecodebunny\SpApi
 */
class VendorDirectFulfillmentPaymentsApi
{
     ...
     *
     * @param  \Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceRequest $body body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse
     */
     ...
     *
     * @param  \Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceRequest $body (required)
     *
     * @throws \Thecodebunny\SpApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoiceWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse', $response->getHeaders());
                case 400:
                    if ('\Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\SpApi\Model\VendorDirectFulfillmentPayments\SubmitInvoiceResponse',
