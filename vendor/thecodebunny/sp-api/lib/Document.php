...
use Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentResponse;
use Thecodebunny\SpApi\Model\Feeds\FeedDocument;
use Thecodebunny\SpApi\Model\Reports\ReportDocument;
    ...
    public function __construct(
        ...
        if (!in_array($this->contentType, array_values($validContentTypes))) {
            ...
            foreach ($validContentTypes as $name => $value) {
                $readableContentTypes[] = "Thecodebunny\SpApi\ContentType::{$name} ($value)";
            }
