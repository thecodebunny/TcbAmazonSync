...
class SmallAndLightFeePreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\Thecodebunny\SpApi\Model\SmallAndLight\Item[]'
    ];
     ...
     * Gets items
     *
     * @return \Thecodebunny\SpApi\Model\SmallAndLight\Item[]
     */
     ...
     * Sets items
     *
     * @param \Thecodebunny\SpApi\Model\SmallAndLight\Item[] $items A list of items for which to retrieve fee estimates (limit: 25).
     *
     * @return self
     */
