...
class Reason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'reason_code' => 'string',
        'links' => '\Thecodebunny\SpApi\Model\ListingsRestrictions\Link[]'
    ];
     ...
     * Gets links
     *
     * @return \Thecodebunny\SpApi\Model\ListingsRestrictions\Link[]|null
     */
     ...
     * Sets links
     *
     * @param \Thecodebunny\SpApi\Model\ListingsRestrictions\Link[]|null $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return self
     */
