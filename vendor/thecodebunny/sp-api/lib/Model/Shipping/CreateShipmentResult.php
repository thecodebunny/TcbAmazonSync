...
class CreateShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\Thecodebunny\SpApi\Model\Shipping\Rate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \Thecodebunny\SpApi\Model\Shipping\Rate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \Thecodebunny\SpApi\Model\Shipping\Rate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */
