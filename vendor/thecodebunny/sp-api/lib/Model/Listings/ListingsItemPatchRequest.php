...
class ListingsItemPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\Thecodebunny\SpApi\Model\Listings\PatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \Thecodebunny\SpApi\Model\Listings\PatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \Thecodebunny\SpApi\Model\Listings\PatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */
