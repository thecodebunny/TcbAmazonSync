...
class Authentication
{
    ...
    public function requestLWAToken(): array
    {
        ...
        // https://github.com/amzn/selling-partner-api-docs/blob/main/guides/developer-guide/Thecodebunny\SpApiDeveloperGuide.md#step-1-request-a-login-with-amazon-access-token
    ...
    public function signRequest(Psr7\Request $request, ?string $scope = null, ?string $restrictedPath = null, ?string $operation = null): Psr7\Request
    {
        ...
        if (!$this->signingScope && ($restrictedPath === null || $dataElements === [])) {
            ...
            if ($operation === 'getReportDocument') {
                ...
                $constantPath = isset($params['reportType']) ? 'Thecodebunny\SpApi\ReportType::' . $params['reportType'] : null;
     ...
     *
     * @return \Thecodebunny\SpApi\Credentials A set of access credentials for making calls to the SP API
     */
     ...
     *
     * @return \Thecodebunny\SpApi\Credentials The grantless credentials
     */
     ...
     *
     * @return \Thecodebunny\SpApi\Credentials A set of STS credentials
     */
     ...
     * @return \Thecodebunny\SpApi\Credentials A Credentials object holding the RDT
     */
     ...
     *
     * @param ?\Thecodebunny\SpApi\Credentials $creds The credentials to check
