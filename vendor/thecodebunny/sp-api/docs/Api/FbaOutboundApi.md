# Thecodebunny\SpApi\FbaOutboundApi
...
```php
cancelFulfillmentOrder($seller_fulfillment_order_id): \Thecodebunny\SpApi\Model\FbaOutbound\CancelFulfillmentOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaOutboundApi($config);
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\CancelFulfillmentOrderResponse**](../Model/FbaOutbound/CancelFulfillmentOrderResponse.md)
...
```php
createFulfillmentOrder($body): \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaOutboundApi($config);
$body = new \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentOrderRequest(); // \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentOrderRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentOrderRequest**](../Model/FbaOutbound/CreateFulfillmentOrderRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentOrderResponse**](../Model/FbaOutbound/CreateFulfillmentOrderResponse.md)
...
```php
createFulfillmentReturn($seller_fulfillment_order_id, $body): \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentReturnResponse
```
...
$body = new \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentReturnRequest(); // \Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentReturnRequest
 ...
 **body** | [**\Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentReturnRequest**](../Model/FbaOutbound/CreateFulfillmentReturnRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaOutbound\CreateFulfillmentReturnResponse**](../Model/FbaOutbound/CreateFulfillmentReturnResponse.md)
...
```php
getFeatureInventory($marketplace_id, $feature_name, $next_token): \Thecodebunny\SpApi\Model\FbaOutbound\GetFeatureInventoryResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\GetFeatureInventoryResponse**](../Model/FbaOutbound/GetFeatureInventoryResponse.md)
...
```php
getFeatureSKU($marketplace_id, $feature_name, $seller_sku): \Thecodebunny\SpApi\Model\FbaOutbound\GetFeatureSkuResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\GetFeatureSkuResponse**](../Model/FbaOutbound/GetFeatureSkuResponse.md)
...
```php
getFeatures($marketplace_id): \Thecodebunny\SpApi\Model\FbaOutbound\GetFeaturesResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\GetFeaturesResponse**](../Model/FbaOutbound/GetFeaturesResponse.md)
...
```php
getFulfillmentOrder($seller_fulfillment_order_id): \Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentOrderResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentOrderResponse**](../Model/FbaOutbound/GetFulfillmentOrderResponse.md)
...
```php
getFulfillmentPreview($body): \Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentPreviewResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaOutboundApi($config);
$body = new \Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentPreviewRequest(); // \Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentPreviewRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentPreviewRequest**](../Model/FbaOutbound/GetFulfillmentPreviewRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaOutbound\GetFulfillmentPreviewResponse**](../Model/FbaOutbound/GetFulfillmentPreviewResponse.md)
...
```php
getPackageTrackingDetails($package_number): \Thecodebunny\SpApi\Model\FbaOutbound\GetPackageTrackingDetailsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\GetPackageTrackingDetailsResponse**](../Model/FbaOutbound/GetPackageTrackingDetailsResponse.md)
...
```php
listAllFulfillmentOrders($query_start_date, $next_token): \Thecodebunny\SpApi\Model\FbaOutbound\ListAllFulfillmentOrdersResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\ListAllFulfillmentOrdersResponse**](../Model/FbaOutbound/ListAllFulfillmentOrdersResponse.md)
...
```php
listReturnReasonCodes($seller_sku, $language, $marketplace_id, $seller_fulfillment_order_id): \Thecodebunny\SpApi\Model\FbaOutbound\ListReturnReasonCodesResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaOutbound\ListReturnReasonCodesResponse**](../Model/FbaOutbound/ListReturnReasonCodesResponse.md)
...
```php
updateFulfillmentOrder($seller_fulfillment_order_id, $body): \Thecodebunny\SpApi\Model\FbaOutbound\UpdateFulfillmentOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaOutboundApi($config);
$seller_fulfillment_order_id = 'seller_fulfillment_order_id_example'; // string | The identifier assigned to the item by the seller when the fulfillment order was created.
$body = new \Thecodebunny\SpApi\Model\FbaOutbound\UpdateFulfillmentOrderRequest(); // \Thecodebunny\SpApi\Model\FbaOutbound\UpdateFulfillmentOrderRequest
...
------------- | ------------- | ------------- | -------------
 **seller_fulfillment_order_id** | **string**| The identifier assigned to the item by the seller when the fulfillment order was created. |
 **body** | [**\Thecodebunny\SpApi\Model\FbaOutbound\UpdateFulfillmentOrderRequest**](../Model/FbaOutbound/UpdateFulfillmentOrderRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaOutbound\UpdateFulfillmentOrderResponse**](../Model/FbaOutbound/UpdateFulfillmentOrderResponse.md)
