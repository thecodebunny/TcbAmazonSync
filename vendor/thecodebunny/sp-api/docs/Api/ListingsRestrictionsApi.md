# Thecodebunny\SpApi\ListingsRestrictionsApi
...
```php
getListingsRestrictions($asin, $seller_id, $marketplace_ids, $condition_type, $reason_locale): \Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ListingsRestrictionsApi($config);
...
[**\Thecodebunny\SpApi\Model\ListingsRestrictions\RestrictionList**](../Model/ListingsRestrictions/RestrictionList.md)
