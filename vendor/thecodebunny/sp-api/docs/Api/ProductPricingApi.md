# Thecodebunny\SpApi\ProductPricingApi
...
```php
getCompetitivePricing($marketplace_id, $item_type, $asins, $skus, $customer_type): \Thecodebunny\SpApi\Model\ProductPricing\GetPricingResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ProductPricingApi($config);
...
[**\Thecodebunny\SpApi\Model\ProductPricing\GetPricingResponse**](../Model/ProductPricing/GetPricingResponse.md)
...
```php
getItemOffers($marketplace_id, $item_condition, $asin, $customer_type): \Thecodebunny\SpApi\Model\ProductPricing\GetOffersResponse
```
...
[**\Thecodebunny\SpApi\Model\ProductPricing\GetOffersResponse**](../Model/ProductPricing/GetOffersResponse.md)
...
```php
getListingOffers($marketplace_id, $item_condition, $seller_sku, $customer_type): \Thecodebunny\SpApi\Model\ProductPricing\GetOffersResponse
```
...
```php
getPricing($marketplace_id, $item_type, $asins, $skus, $item_condition, $offer_type): \Thecodebunny\SpApi\Model\ProductPricing\GetPricingResponse
```
