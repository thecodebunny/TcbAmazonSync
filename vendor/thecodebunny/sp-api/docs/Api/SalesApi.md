...
```php
getOrderMetrics($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku): \Thecodebunny\SpApi\Model\Sales\GetOrderMetricsResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\SalesApi($config);
...
[**\Thecodebunny\SpApi\Model\Sales\GetOrderMetricsResponse**](../Model/Sales/GetOrderMetricsResponse.md)
