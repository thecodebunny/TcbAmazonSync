# Thecodebunny\SpApi\VendorTransactionStatusApi
...
```php
getTransaction($transaction_id): \Thecodebunny\SpApi\Model\VendorTransactionStatus\GetTransactionResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorTransactionStatusApi($config);
...
[**\Thecodebunny\SpApi\Model\VendorTransactionStatus\GetTransactionResponse**](../Model/VendorTransactionStatus/GetTransactionResponse.md)
