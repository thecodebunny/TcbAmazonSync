# Thecodebunny\SpApi\ProductTypeDefinitionsApi
...
```php
getDefinitionsProductType($product_type, $marketplace_ids, $seller_id, $product_type_version, $requirements, $requirements_enforced, $locale): \Thecodebunny\SpApi\Model\ProductTypeDefinitions\ProductTypeDefinition
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ProductTypeDefinitionsApi($config);
...
[**\Thecodebunny\SpApi\Model\ProductTypeDefinitions\ProductTypeDefinition**](../Model/ProductTypeDefinitions/ProductTypeDefinition.md)
...
```php
searchDefinitionsProductTypes($marketplace_ids, $keywords): \Thecodebunny\SpApi\Model\ProductTypeDefinitions\ProductTypeList
```
...
[**\Thecodebunny\SpApi\Model\ProductTypeDefinitions\ProductTypeList**](../Model/ProductTypeDefinitions/ProductTypeList.md)
