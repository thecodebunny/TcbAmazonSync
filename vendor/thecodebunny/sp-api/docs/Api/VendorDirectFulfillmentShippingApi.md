# Thecodebunny\SpApi\VendorDirectFulfillmentShippingApi
...
```php
getCustomerInvoice($purchase_order_number): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetCustomerInvoiceResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentShippingApi($config);
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetCustomerInvoiceResponse**](../Model/VendorDirectFulfillmentShipping/GetCustomerInvoiceResponse.md)
...
```php
getCustomerInvoices($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetCustomerInvoicesResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetCustomerInvoicesResponse**](../Model/VendorDirectFulfillmentShipping/GetCustomerInvoicesResponse.md)
...
```php
getPackingSlip($purchase_order_number): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetPackingSlipResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetPackingSlipResponse**](../Model/VendorDirectFulfillmentShipping/GetPackingSlipResponse.md)
...
```php
getPackingSlips($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetPackingSlipListResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetPackingSlipListResponse**](../Model/VendorDirectFulfillmentShipping/GetPackingSlipListResponse.md)
...
```php
getShippingLabel($purchase_order_number): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetShippingLabelResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetShippingLabelResponse**](../Model/VendorDirectFulfillmentShipping/GetShippingLabelResponse.md)
...
```php
getShippingLabels($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetShippingLabelListResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\GetShippingLabelListResponse**](../Model/VendorDirectFulfillmentShipping/GetShippingLabelListResponse.md)
...
```php
submitShipmentConfirmations($body): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentShippingApi($config);
$body = new \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsRequest(); // \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsRequest**](../Model/VendorDirectFulfillmentShipping/SubmitShipmentConfirmationsRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentConfirmationsResponse**](../Model/VendorDirectFulfillmentShipping/SubmitShipmentConfirmationsResponse.md)
...
```php
submitShipmentStatusUpdates($body): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentShippingApi($config);
$body = new \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesRequest(); // \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesRequest**](../Model/VendorDirectFulfillmentShipping/SubmitShipmentStatusUpdatesRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShipmentStatusUpdatesResponse**](../Model/VendorDirectFulfillmentShipping/SubmitShipmentStatusUpdatesResponse.md)
...
```php
submitShippingLabelRequest($body): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShippingLabelsResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentShippingApi($config);
$body = new \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShippingLabelsRequest(); // \Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShippingLabelsRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShippingLabelsRequest**](../Model/VendorDirectFulfillmentShipping/SubmitShippingLabelsRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentShipping\SubmitShippingLabelsResponse**](../Model/VendorDirectFulfillmentShipping/SubmitShippingLabelsResponse.md)
