# Thecodebunny\SpApi\FbaInboundApi
...
```php
confirmPreorder($shipment_id, $need_by_date, $marketplace_id): \Thecodebunny\SpApi\Model\FbaInbound\ConfirmPreorderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaInboundApi($config);
...
[**\Thecodebunny\SpApi\Model\FbaInbound\ConfirmPreorderResponse**](../Model/FbaInbound/ConfirmPreorderResponse.md)
...
```php
confirmTransport($shipment_id): \Thecodebunny\SpApi\Model\FbaInbound\ConfirmTransportResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\ConfirmTransportResponse**](../Model/FbaInbound/ConfirmTransportResponse.md)
...
```php
createInboundShipment($shipment_id, $body): \Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaInboundApi($config);
$shipment_id = 'shipment_id_example'; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
$body = new \Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentRequest(); // \Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentRequest
...
------------- | ------------- | ------------- | -------------
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |
 **body** | [**\Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentRequest**](../Model/FbaInbound/InboundShipmentRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentResponse**](../Model/FbaInbound/InboundShipmentResponse.md)
...
```php
createInboundShipmentPlan($body): \Thecodebunny\SpApi\Model\FbaInbound\CreateInboundShipmentPlanResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaInboundApi($config);
$body = new \Thecodebunny\SpApi\Model\FbaInbound\CreateInboundShipmentPlanRequest(); // \Thecodebunny\SpApi\Model\FbaInbound\CreateInboundShipmentPlanRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\FbaInbound\CreateInboundShipmentPlanRequest**](../Model/FbaInbound/CreateInboundShipmentPlanRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaInbound\CreateInboundShipmentPlanResponse**](../Model/FbaInbound/CreateInboundShipmentPlanResponse.md)
...
```php
estimateTransport($shipment_id): \Thecodebunny\SpApi\Model\FbaInbound\EstimateTransportResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\EstimateTransportResponse**](../Model/FbaInbound/EstimateTransportResponse.md)
...
```php
getBillOfLading($shipment_id): \Thecodebunny\SpApi\Model\FbaInbound\GetBillOfLadingResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetBillOfLadingResponse**](../Model/FbaInbound/GetBillOfLadingResponse.md)
...
```php
getInboundGuidance($marketplace_id, $seller_sku_list, $asin_list): \Thecodebunny\SpApi\Model\FbaInbound\GetInboundGuidanceResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetInboundGuidanceResponse**](../Model/FbaInbound/GetInboundGuidanceResponse.md)
...
```php
getLabels($shipment_id, $page_type, $label_type, $number_of_packages, $package_labels_to_print, $number_of_pallets, $page_size, $page_start_index): \Thecodebunny\SpApi\Model\FbaInbound\GetLabelsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetLabelsResponse**](../Model/FbaInbound/GetLabelsResponse.md)
...
```php
getPreorderInfo($shipment_id, $marketplace_id): \Thecodebunny\SpApi\Model\FbaInbound\GetPreorderInfoResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetPreorderInfoResponse**](../Model/FbaInbound/GetPreorderInfoResponse.md)
...
```php
getPrepInstructions($ship_to_country_code, $seller_sku_list, $asin_list): \Thecodebunny\SpApi\Model\FbaInbound\GetPrepInstructionsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetPrepInstructionsResponse**](../Model/FbaInbound/GetPrepInstructionsResponse.md)
...
```php
getShipmentItems($query_type, $marketplace_id, $last_updated_after, $last_updated_before, $next_token): \Thecodebunny\SpApi\Model\FbaInbound\GetShipmentItemsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetShipmentItemsResponse**](../Model/FbaInbound/GetShipmentItemsResponse.md)
...
```php
getShipmentItemsByShipmentId($shipment_id, $marketplace_id): \Thecodebunny\SpApi\Model\FbaInbound\GetShipmentItemsResponse
```
...
```php
getShipments($query_type, $marketplace_id, $shipment_status_list, $shipment_id_list, $last_updated_after, $last_updated_before, $next_token): \Thecodebunny\SpApi\Model\FbaInbound\GetShipmentsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetShipmentsResponse**](../Model/FbaInbound/GetShipmentsResponse.md)
...
```php
getTransportDetails($shipment_id): \Thecodebunny\SpApi\Model\FbaInbound\GetTransportDetailsResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\GetTransportDetailsResponse**](../Model/FbaInbound/GetTransportDetailsResponse.md)
...
```php
putTransportDetails($shipment_id, $body): \Thecodebunny\SpApi\Model\FbaInbound\PutTransportDetailsResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FbaInboundApi($config);
$shipment_id = 'shipment_id_example'; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
$body = new \Thecodebunny\SpApi\Model\FbaInbound\PutTransportDetailsRequest(); // \Thecodebunny\SpApi\Model\FbaInbound\PutTransportDetailsRequest
...
------------- | ------------- | ------------- | -------------
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |
 **body** | [**\Thecodebunny\SpApi\Model\FbaInbound\PutTransportDetailsRequest**](../Model/FbaInbound/PutTransportDetailsRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\FbaInbound\PutTransportDetailsResponse**](../Model/FbaInbound/PutTransportDetailsResponse.md)
...
```php
updateInboundShipment($shipment_id, $body): \Thecodebunny\SpApi\Model\FbaInbound\InboundShipmentResponse
```
...
```php
voidTransport($shipment_id): \Thecodebunny\SpApi\Model\FbaInbound\VoidTransportResponse
```
...
[**\Thecodebunny\SpApi\Model\FbaInbound\VoidTransportResponse**](../Model/FbaInbound/VoidTransportResponse.md)
