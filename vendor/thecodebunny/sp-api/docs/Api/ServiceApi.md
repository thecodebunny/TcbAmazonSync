...
```php
addAppointmentForServiceJobByServiceJobId($service_job_id, $body): \Thecodebunny\SpApi\Model\Service\SetAppointmentResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ServiceApi($config);
$service_job_id = 'service_job_id_example'; // string | An Amazon defined service job identifier.
$body = new \Thecodebunny\SpApi\Model\Service\AddAppointmentRequest(); // \Thecodebunny\SpApi\Model\Service\AddAppointmentRequest | Add appointment operation input details.
 ...
 **body** | [**\Thecodebunny\SpApi\Model\Service\AddAppointmentRequest**](../Model/Service/AddAppointmentRequest.md)| Add appointment operation input details. |

### Return type

[**\Thecodebunny\SpApi\Model\Service\SetAppointmentResponse**](../Model/Service/SetAppointmentResponse.md)
...
```php
cancelServiceJobByServiceJobId($service_job_id, $cancellation_reason_code): \Thecodebunny\SpApi\Model\Service\CancelServiceJobByServiceJobIdResponse
```
...
[**\Thecodebunny\SpApi\Model\Service\CancelServiceJobByServiceJobIdResponse**](../Model/Service/CancelServiceJobByServiceJobIdResponse.md)
...
```php
completeServiceJobByServiceJobId($service_job_id): \Thecodebunny\SpApi\Model\Service\CompleteServiceJobByServiceJobIdResponse
```
...
[**\Thecodebunny\SpApi\Model\Service\CompleteServiceJobByServiceJobIdResponse**](../Model/Service/CompleteServiceJobByServiceJobIdResponse.md)
...
```php
getServiceJobByServiceJobId($service_job_id): \Thecodebunny\SpApi\Model\Service\GetServiceJobByServiceJobIdResponse
```
...
[**\Thecodebunny\SpApi\Model\Service\GetServiceJobByServiceJobIdResponse**](../Model/Service/GetServiceJobByServiceJobIdResponse.md)
...
```php
getServiceJobs($marketplace_ids, $service_order_ids, $service_job_status, $page_token, $page_size, $sort_field, $sort_order, $created_after, $created_before, $last_updated_after, $last_updated_before, $schedule_start_date, $schedule_end_date): \Thecodebunny\SpApi\Model\Service\GetServiceJobsResponse
```
...
[**\Thecodebunny\SpApi\Model\Service\GetServiceJobsResponse**](../Model/Service/GetServiceJobsResponse.md)
...
```php
rescheduleAppointmentForServiceJobByServiceJobId($service_job_id, $appointment_id, $body): \Thecodebunny\SpApi\Model\Service\SetAppointmentResponse
```
...
$body = new \Thecodebunny\SpApi\Model\Service\RescheduleAppointmentRequest(); // \Thecodebunny\SpApi\Model\Service\RescheduleAppointmentRequest | Reschedule appointment operation input details.
 ...
 **body** | [**\Thecodebunny\SpApi\Model\Service\RescheduleAppointmentRequest**](../Model/Service/RescheduleAppointmentRequest.md)| Reschedule appointment operation input details. |
