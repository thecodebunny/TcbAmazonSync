...
$apiInstance = new Thecodebunny\SpApi\Api\ReportsApi($config);
...
```php
createReport($body): \Thecodebunny\SpApi\Model\Reports\CreateReportResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ReportsApi($config);
$body = new \Thecodebunny\SpApi\Model\Reports\CreateReportSpecification(); // \Thecodebunny\SpApi\Model\Reports\CreateReportSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\Reports\CreateReportSpecification**](../Model/Reports/CreateReportSpecification.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\Reports\CreateReportResponse**](../Model/Reports/CreateReportResponse.md)
...
```php
createReportSchedule($body): \Thecodebunny\SpApi\Model\Reports\CreateReportScheduleResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\ReportsApi($config);
$body = new \Thecodebunny\SpApi\Model\Reports\CreateReportScheduleSpecification(); // \Thecodebunny\SpApi\Model\Reports\CreateReportScheduleSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\Reports\CreateReportScheduleSpecification**](../Model/Reports/CreateReportScheduleSpecification.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\Reports\CreateReportScheduleResponse**](../Model/Reports/CreateReportScheduleResponse.md)
...
```php
getReport($report_id): \Thecodebunny\SpApi\Model\Reports\Report
```
...
[**\Thecodebunny\SpApi\Model\Reports\Report**](../Model/Reports/Report.md)
...
```php
getReportDocument($report_document_id, $report_type): \Thecodebunny\SpApi\Model\Reports\ReportDocument
```
...
[**\Thecodebunny\SpApi\Model\Reports\ReportDocument**](../Model/Reports/ReportDocument.md)
...
```php
getReportSchedule($report_schedule_id): \Thecodebunny\SpApi\Model\Reports\ReportSchedule
```
...
[**\Thecodebunny\SpApi\Model\Reports\ReportSchedule**](../Model/Reports/ReportSchedule.md)
...
```php
getReportSchedules($report_types): \Thecodebunny\SpApi\Model\Reports\ReportScheduleList
```
...
[**\Thecodebunny\SpApi\Model\Reports\ReportScheduleList**](../Model/Reports/ReportScheduleList.md)
...
```php
getReports($report_types, $processing_statuses, $marketplace_ids, $page_size, $created_since, $created_until, $next_token): \Thecodebunny\SpApi\Model\Reports\GetReportsResponse
```
...
[**\Thecodebunny\SpApi\Model\Reports\GetReportsResponse**](../Model/Reports/GetReportsResponse.md)
