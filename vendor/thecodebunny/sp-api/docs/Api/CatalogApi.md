...
```php
getCatalogItem($asin, $marketplace_ids, $included_data, $locale): \Thecodebunny\SpApi\Model\Catalog\Item
```
...
$apiInstance = new Thecodebunny\SpApi\Api\CatalogApi($config);
...
[**\Thecodebunny\SpApi\Model\Catalog\Item**](../Model/Catalog/Item.md)
...
```php
searchCatalogItems($keywords, $marketplace_ids, $included_data, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale, $locale): \Thecodebunny\SpApi\Model\Catalog\ItemSearchResults
```
...
[**\Thecodebunny\SpApi\Model\Catalog\ItemSearchResults**](../Model/Catalog/ItemSearchResults.md)
