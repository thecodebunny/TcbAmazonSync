...
```php
getOrder($order_id, $data_elements): \Thecodebunny\SpApi\Model\Orders\GetOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\OrdersApi($config);
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrderResponse**](../Model/Orders/GetOrderResponse.md)
...
```php
getOrderAddress($order_id): \Thecodebunny\SpApi\Model\Orders\GetOrderAddressResponse
```
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrderAddressResponse**](../Model/Orders/GetOrderAddressResponse.md)
...
```php
getOrderBuyerInfo($order_id): \Thecodebunny\SpApi\Model\Orders\GetOrderBuyerInfoResponse
```
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrderBuyerInfoResponse**](../Model/Orders/GetOrderBuyerInfoResponse.md)
...
```php
getOrderItems($order_id, $next_token, $data_elements): \Thecodebunny\SpApi\Model\Orders\GetOrderItemsResponse
```
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrderItemsResponse**](../Model/Orders/GetOrderItemsResponse.md)
...
```php
getOrderItemsBuyerInfo($order_id, $next_token): \Thecodebunny\SpApi\Model\Orders\GetOrderItemsBuyerInfoResponse
```
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrderItemsBuyerInfoResponse**](../Model/Orders/GetOrderItemsBuyerInfoResponse.md)
...
[**\Thecodebunny\SpApi\Model\Orders\GetOrdersResponse**](../Model/Orders/GetOrdersResponse.md)
