# Thecodebunny\SpApi\FinancesApi
...
```php
listFinancialEventGroups($max_results_per_page, $financial_event_group_started_before, $financial_event_group_started_after, $next_token): \Thecodebunny\SpApi\Model\Finances\ListFinancialEventGroupsResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FinancesApi($config);
...
[**\Thecodebunny\SpApi\Model\Finances\ListFinancialEventGroupsResponse**](../Model/Finances/ListFinancialEventGroupsResponse.md)
...
```php
listFinancialEvents($max_results_per_page, $posted_after, $posted_before, $next_token): \Thecodebunny\SpApi\Model\Finances\ListFinancialEventsResponse
```
...
[**\Thecodebunny\SpApi\Model\Finances\ListFinancialEventsResponse**](../Model/Finances/ListFinancialEventsResponse.md)
...
```php
listFinancialEventsByGroupId($event_group_id, $max_results_per_page, $next_token): \Thecodebunny\SpApi\Model\Finances\ListFinancialEventsResponse
```
...
```php
listFinancialEventsByOrderId($order_id, $max_results_per_page, $next_token): \Thecodebunny\SpApi\Model\Finances\ListFinancialEventsResponse
```
