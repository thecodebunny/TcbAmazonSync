# Thecodebunny\SpApi\SmallAndLightApi
...
$apiInstance = new Thecodebunny\SpApi\Api\SmallAndLightApi($config);
...
```php
getSmallAndLightEligibilityBySellerSKU($seller_sku, $marketplace_ids): \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightEligibility
```
...
[**\Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightEligibility**](../Model/SmallAndLight/SmallAndLightEligibility.md)
...
```php
getSmallAndLightEnrollmentBySellerSKU($seller_sku, $marketplace_ids): \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightEnrollment
```
...
[**\Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightEnrollment**](../Model/SmallAndLight/SmallAndLightEnrollment.md)
...
```php
getSmallAndLightFeePreview($body): \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightFeePreviews
```
...
$apiInstance = new Thecodebunny\SpApi\Api\SmallAndLightApi($config);
$body = new \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightFeePreviewRequest(); // \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightFeePreviewRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightFeePreviewRequest**](../Model/SmallAndLight/SmallAndLightFeePreviewRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightFeePreviews**](../Model/SmallAndLight/SmallAndLightFeePreviews.md)
...
```php
putSmallAndLightEnrollmentBySellerSKU($seller_sku, $marketplace_ids): \Thecodebunny\SpApi\Model\SmallAndLight\SmallAndLightEnrollment
```
