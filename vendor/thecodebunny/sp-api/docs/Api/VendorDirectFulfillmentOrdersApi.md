# Thecodebunny\SpApi\VendorDirectFulfillmentOrdersApi
...
```php
getOrder($purchase_order_number): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\GetOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentOrdersApi($config);
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\GetOrderResponse**](../Model/VendorDirectFulfillmentOrders/GetOrderResponse.md)
...
```php
getOrders($created_after, $created_before, $ship_from_party_id, $status, $limit, $sort_order, $next_token, $include_details): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\GetOrdersResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\GetOrdersResponse**](../Model/VendorDirectFulfillmentOrders/GetOrdersResponse.md)
...
```php
submitAcknowledgement($body): \Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorDirectFulfillmentOrdersApi($config);
$body = new \Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementRequest(); // \Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementRequest**](../Model/VendorDirectFulfillmentOrders/SubmitAcknowledgementRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\VendorDirectFulfillmentOrders\SubmitAcknowledgementResponse**](../Model/VendorDirectFulfillmentOrders/SubmitAcknowledgementResponse.md)
