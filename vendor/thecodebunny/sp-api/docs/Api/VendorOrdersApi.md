# Thecodebunny\SpApi\VendorOrdersApi
...
```php
getPurchaseOrder($purchase_order_number): \Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrderResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorOrdersApi($config);
...
[**\Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrderResponse**](../Model/VendorOrders/GetPurchaseOrderResponse.md)
...
```php
getPurchaseOrders($limit, $created_after, $created_before, $sort_order, $next_token, $include_details, $changed_after, $changed_before, $po_item_state, $is_po_changed, $purchase_order_state, $ordering_vendor_code): \Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrdersResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrdersResponse**](../Model/VendorOrders/GetPurchaseOrdersResponse.md)
...
```php
getPurchaseOrdersStatus($limit, $sort_order, $next_token, $created_after, $created_before, $updated_after, $updated_before, $purchase_order_number, $purchase_order_status, $item_confirmation_status, $ordering_vendor_code, $ship_to_party_id): \Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrdersStatusResponse
```
...
[**\Thecodebunny\SpApi\Model\VendorOrders\GetPurchaseOrdersStatusResponse**](../Model/VendorOrders/GetPurchaseOrdersStatusResponse.md)
...
```php
submitAcknowledgement($body): \Thecodebunny\SpApi\Model\VendorOrders\SubmitAcknowledgementResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\VendorOrdersApi($config);
$body = new \Thecodebunny\SpApi\Model\VendorOrders\SubmitAcknowledgementRequest(); // \Thecodebunny\SpApi\Model\VendorOrders\SubmitAcknowledgementRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\VendorOrders\SubmitAcknowledgementRequest**](../Model/VendorOrders/SubmitAcknowledgementRequest.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\VendorOrders\SubmitAcknowledgementResponse**](../Model/VendorOrders/SubmitAcknowledgementResponse.md)
