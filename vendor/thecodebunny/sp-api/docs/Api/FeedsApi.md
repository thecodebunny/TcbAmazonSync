...
$apiInstance = new Thecodebunny\SpApi\Api\FeedsApi($config);
...
```php
createFeed($body): \Thecodebunny\SpApi\Model\Feeds\CreateFeedResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FeedsApi($config);
$body = new \Thecodebunny\SpApi\Model\Feeds\CreateFeedSpecification(); // \Thecodebunny\SpApi\Model\Feeds\CreateFeedSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\Feeds\CreateFeedSpecification**](../Model/Feeds/CreateFeedSpecification.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\Feeds\CreateFeedResponse**](../Model/Feeds/CreateFeedResponse.md)
...
```php
createFeedDocument($body): \Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentResponse
```
...
$apiInstance = new Thecodebunny\SpApi\Api\FeedsApi($config);
$body = new \Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentSpecification(); // \Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentSpecification**](../Model/Feeds/CreateFeedDocumentSpecification.md)|  |

### Return type

[**\Thecodebunny\SpApi\Model\Feeds\CreateFeedDocumentResponse**](../Model/Feeds/CreateFeedDocumentResponse.md)
...
```php
getFeed($feed_id): \Thecodebunny\SpApi\Model\Feeds\Feed
```
...
[**\Thecodebunny\SpApi\Model\Feeds\Feed**](../Model/Feeds/Feed.md)
...
```php
getFeedDocument($feed_document_id): \Thecodebunny\SpApi\Model\Feeds\FeedDocument
```
...
[**\Thecodebunny\SpApi\Model\Feeds\FeedDocument**](../Model/Feeds/FeedDocument.md)
...
```php
getFeeds($feed_types, $marketplace_ids, $page_size, $processing_statuses, $created_since, $created_until, $next_token): \Thecodebunny\SpApi\Model\Feeds\GetFeedsResponse
```
...
[**\Thecodebunny\SpApi\Model\Feeds\GetFeedsResponse**](../Model/Feeds/GetFeedsResponse.md)
