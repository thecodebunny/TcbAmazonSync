...
**order_total** | [**\Thecodebunny\SpApi\Model\Orders\Money**](Money.md) |  | [optional]
...
**payment_execution_detail** | [**\Thecodebunny\SpApi\Model\Orders\PaymentExecutionDetailItem[]**](PaymentExecutionDetailItem.md) | A list of payment execution detail items. | [optional]
...
**default_ship_from_location_address** | [**\Thecodebunny\SpApi\Model\Orders\Address**](Address.md) |  | [optional]
**fulfillment_instruction** | [**\Thecodebunny\SpApi\Model\Orders\FulfillmentInstruction**](FulfillmentInstruction.md) |  | [optional]
**is_ispu** | **bool** | When true, this order is marked to be picked up from a store rather than delivered. | [optional]
**marketplace_tax_info** | [**\Thecodebunny\SpApi\Model\Orders\MarketplaceTaxInfo**](MarketplaceTaxInfo.md) |  | [optional]
...
**buyer_info** | [**\Thecodebunny\SpApi\Model\Orders\BuyerInfo**](BuyerInfo.md) |  | [optional]
