...
use PaApi\Operations\CartModify;
...
$domDoc = $paApi->runOperation($cartCreate);
...
$domDoc = $paApi->runOperation($cartAdd);
...
$domDoc = $paApi->runOperation($cartModify);   // <-- IMPORTANT! Always be precise with ResponseGroup
                                                //                to avoid getting preliminary RateLimit
