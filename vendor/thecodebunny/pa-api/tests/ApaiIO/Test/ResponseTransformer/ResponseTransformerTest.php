...
namespace PaApi\Test\ResponseTransformer;

use PaApi\ResponseTransformer\XmlToArray;
use PaApi\ResponseTransformer\XmlToDomDocument;
use PaApi\ResponseTransformer\XmlToSimpleXmlObject;
