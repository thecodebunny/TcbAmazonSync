...
.. code-block:: php
    ...
    namespace PaApi\ResponseTransformer;
...
.. code-block:: php
    ...
    $response = $paApi->runOperation($operation);
...
.. code-block:: php
    ...
    $conf
        ...
        ->setAssociateTag(AWS_ASSOCIATE_TAG)
        ->setRequest($request)
        ->setResponseTransformer(new \PaApi\ResponseTransformer\XmlToArray());
...
.. code-block:: php
    ...
    use PaApi\Configuration\GenericConfiguration;
    use PaApi\PaApi;
    use PaApi\ResponseTransformer\Xslt;
