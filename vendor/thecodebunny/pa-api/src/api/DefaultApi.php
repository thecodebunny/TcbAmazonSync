 ...
 */
namespace TheCodeBunny\PaApi\api;
...
use TheCodeBunny\PaApi\SignHelper;
use http\Exception;
...
class DefaultApi
{
     ...
     *
     * @param  \TheCodeBunny\PaApi\GetBrowseNodesRequest $getBrowseNodesRequest GetBrowseNodesRequest (required)
     *
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TheCodeBunny\PaApi\GetBrowseNodesResponse
     */
     ...
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TheCodeBunny\PaApi\GetBrowseNodesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrowseNodesWithHttpInfo($getBrowseNodesRequest)
    {
        $returnType = '\TheCodeBunny\PaApi\GetBrowseNodesResponse';
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\TheCodeBunny\PaApi\ProductAdvertisingAPIClientException',
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\TheCodeBunny\PaApi\ProductAdvertisingAPIServiceException',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation getItems
     *
     * @param  \TheCodeBunny\PaApi\GetItemsRequest $getItemsRequest GetItemsRequest (required)
     *
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TheCodeBunny\PaApi\GetItemsResponse
     */
     ...
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TheCodeBunny\PaApi\GetItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsWithHttpInfo($getItemsRequest)
    {
        $returnType = '\TheCodeBunny\PaApi\GetItemsResponse';
     ...
     *
     * @param  \TheCodeBunny\PaApi\GetVariationsRequest $getVariationsRequest GetVariationsRequest (required)
     *
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TheCodeBunny\PaApi\GetVariationsResponse
     */
     ...
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TheCodeBunny\PaApi\GetVariationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationsWithHttpInfo($getVariationsRequest)
    {
        $returnType = '\TheCodeBunny\PaApi\GetVariationsResponse';
     ...
     *
     * @param  \TheCodeBunny\PaApi\SearchItemsRequest $searchItemsRequest SearchItemsRequest (required)
     *
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TheCodeBunny\PaApi\SearchItemsResponse
     */
     ...
     * @throws \TheCodeBunny\PaApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TheCodeBunny\PaApi\SearchItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchItemsWithHttpInfo($searchItemsRequest)
    {
        $returnType = '\TheCodeBunny\PaApi\SearchItemsResponse';
