...
class OfferCondition implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'locale' => 'string',
        'value' => 'string',
        'subCondition' => '\TheCodeBunny\PaApi\OfferSubCondition'
    ];
     ...
     * Gets subCondition
     *
     * @return \TheCodeBunny\PaApi\OfferSubCondition
     */
     ...
     * Sets subCondition
     *
     * @param \TheCodeBunny\PaApi\OfferSubCondition $subCondition subCondition
     *
     * @return $this
     */
