...
class OfferDeliveryInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shippingCharges' => '\TheCodeBunny\PaApi\OfferShippingCharge[]'
    ];
     ...
     *
     * @return \TheCodeBunny\PaApi\OfferShippingCharge[]
     */
     ...
     *
     * @param \TheCodeBunny\PaApi\OfferShippingCharge[] $shippingCharges shippingCharges
     *
     * @return $this
     */
